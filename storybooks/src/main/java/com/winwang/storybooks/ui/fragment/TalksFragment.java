...
import com.winwang.storybooks.di.component.DaggerTalksComponent;
import com.winwang.storybooks.mvp.contract.TalksContract;
import com.winwang.storybooks.mvp.presenter.TalksPresenter;
 ...
 * ================================================
 */
public class TalksFragment extends BaseLazyLoadFragment<TalksPresenter> implements TalksContract.View {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerTalksComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    protected void lazyLoadData() {
        rvTalks.setLayoutManager(mGridLayoutManager);
        rvTalks.setAdapter(mAdapter);
        mPresenter.getTalkList(1, 2);
    }
